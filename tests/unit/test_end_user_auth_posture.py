...
read
    ...
    bind_profile == local AND profile chosen AND ITSMDESK_S2S_TOKEN unset
...
from itsm_servicedesk_triage.adapters.local.identity import (
    LocalIdentityAdapter,
)
from itsm_servicedesk_triage.adapters.onprem.identity import (
