...
from itsm_servicedesk_triage.adapters.gcp.identity import IapIdentityAdapter
...
def _adapter_module() -> object:
    ...
    return importlib.import_module("itsm_servicedesk_triage.adapters.gcp.identity")
