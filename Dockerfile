# ITSM Service Desk Agent (H3) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    ITSMDESK_PROFILE=gcp \
    ITSMDESK_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "exec uvicorn itsm_servicedesk_triage.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
